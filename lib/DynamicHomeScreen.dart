...
import 'package:recipeapp/Recipe Suggestion.dart' hide IngredientListScreen, RecipeListScreen;
import 'FoodRecogvideoscreen.dart';
...
import 'meal preparation screen.dart' hide RecipeListScreen;
import 'recipe rating  system.dart';
import 'morescreen.dart';
import 'meal preparation screen.dart';
        ...
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Container(height: 120, width: 160, color: Colors.green.shade200,child: InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>modelscreen()));
                     },
                    child: Center(child: Text('Recipe Suggestion'
                        '',))),),
                ...
                Container(
                  ...
                  child: InkWell(
                    ...
                    child: Center(child: Text('Meal Preparation')),
                  ),
                ),
            ...
            Row(
              ...
              children: [
                ...
                Container(height: 120, width: 160, color: Colors.green.shade200,child: InkWell(
                    ...
                    child: Center(child: Text('Recipe Rating',))),),
              ],
            ),
            SizedBox(height: 10,),
            Container(height: 120, width: 160, color: Colors.green.shade200,child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>FoodRecogVideoScreen()));
                },
                child: Center(child: Text('Video screen '
                    '',))),),
          ],
        ),
      ),
